...
import com.keep.safe.databinding.ActivitySetPinsBinding;
import com.keep.safe.ui.HomeActivity;
...
public class SetPinActivity extends AppCompatActivity  {
    ...
    boolean status;
    private String pin = "";
    ActivitySetPinsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_set_pins);
